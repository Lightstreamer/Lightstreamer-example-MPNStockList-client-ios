...
* For a version of this example compatible with Lightstreamer iOS and watchOS Client SDKs versions up to 4.2.1, please refer to [this tag](https://github.com/Lightstreamer/Lightstreamer-example-MPNStockList-client-ios/tree/latest-for-cocoapods).
